        ...
        <div class="card-body">
            <form action="{{ route('pets.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('category_id') is-invalid @enderror" id="category_id" name="category_id" value="{{ old('category_id') }}">
                            @error('category_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags" name="tags" value="{{ old('tags') }}" placeholder="np. młody, przyjazny, szkolony">
                    @error('tags')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('photoUrls') is-invalid @enderror" id="photoUrls" name="photoUrls" value="{{ old('photoUrls') }}" placeholder="np. http://example.com/img1.jpg, http://example.com/img2.jpg">
                    @error('photoUrls')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">Wprowadź adresy URL oddzielone przecinkami, np. "https://picsum.photos/id/237/200/300" skopiuj i sprawdź</div>
                </div>
